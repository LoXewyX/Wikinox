const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RightTriangleDiagram-Do66tegW.js","assets/jsxRuntime.module-BcIaG-9p.js","assets/index-C1BT9wAk.js","assets/index-DBwiFk51.css"])))=>i.map(i=>d[i]);
import{t as e}from"./jsxRuntime.module-BcIaG-9p.js";import{c as t,d as n,f as r}from"./index-C1BT9wAk.js";import{t as i}from"./TopicPage-DZNFNl0A.js";var a=`# Resolución de triángulos rectángulos
...
`;function c(){let{locale:c}=t();return e(i,{id:`right-triangle-solving`,content:{es:a,ca:o,en:s}[c],directiveComponents:{"right-triangle-diagram":n(()=>r(()=>import(`./RightTriangleDiagram-Do66tegW.js`),__vite__mapDeps([0,1,2,3])))}})}export{c as default};