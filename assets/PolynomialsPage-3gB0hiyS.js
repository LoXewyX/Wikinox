const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/PolynomialGraph-DDeXanA7.js","assets/rolldown-runtime-B0Z9INg1.js","assets/jsxRuntime.module-BcIaG-9p.js","assets/index-C1BT9wAk.js","assets/index-DBwiFk51.css","assets/Card-CSrVt1SD.js","assets/dist-DgzhcLSW.js"])))=>i.map(i=>d[i]);
import{t as e}from"./jsxRuntime.module-BcIaG-9p.js";import{c as t,d as n,f as r}from"./index-C1BT9wAk.js";import{t as i}from"./TopicPage-DZNFNl0A.js";var a=`# Polinomios
...
`;function c(){let{locale:c}=t();return e(i,{id:`polynomials`,content:{es:a,ca:o,en:s}[c],directiveComponents:{"polynomial-graph":n(()=>r(()=>import(`./PolynomialGraph-DDeXanA7.js`),__vite__mapDeps([0,1,2,3,4,5,6])))}})}export{c as default};