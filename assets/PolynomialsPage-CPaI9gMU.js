const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/PolynomialGraph-B0E8LNiw.js","assets/rolldown-runtime-B0Z9INg1.js","assets/jsxRuntime.module-BcIaG-9p.js","assets/index-BYtsCiYd.js","assets/index-BUO5hoW9.css","assets/Card-CSrVt1SD.js","assets/dist-DgzhcLSW.js"])))=>i.map(i=>d[i]);
import{t as e}from"./jsxRuntime.module-BcIaG-9p.js";import{c as t,d as n,f as r}from"./index-BYtsCiYd.js";import{t as i}from"./TopicPage-BAzQYl-h.js";var a=`# Polinomios
...
`;function c(){let{locale:c}=t();return e(i,{id:`polynomials`,content:{es:a,ca:o,en:s}[c],directiveComponents:{"polynomial-graph":n(()=>r(()=>import(`./PolynomialGraph-B0E8LNiw.js`),__vite__mapDeps([0,1,2,3,4,5,6])))}})}export{c as default};