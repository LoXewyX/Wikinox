...
import{t as e}from"./jsxRuntime.module-BcIaG-9p.js";import{c as t,d as n,f as r}from"./index-BYtsCiYd.js";import{t as i}from"./TopicPage-BAzQYl-h.js";var a=`# Funciones exponenciales y logarítmicas
...
\\log_a(x):\\quad x>0
$$
`;function c(){let{locale:c}=t();return e(i,{id:`exponential-logarithmic-functions`,content:{es:a,ca:o,en:s}[c],directiveComponents:{"function-graph":n(()=>r(()=>import(`./FunctionGraph-WuYhu2Kl.js`),__vite__mapDeps([0,1,2,3,4,5,6])))}})}export{c as default};