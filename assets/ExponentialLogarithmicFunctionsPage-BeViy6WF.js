...
import{t as e}from"./jsxRuntime.module-BcIaG-9p.js";import{c as t,d as n,f as r}from"./index-CC0Uwr-v.js";import{t as i}from"./TopicPage-CxUbQKDL.js";var a=`# Funciones exponenciales y logarítmicas
...
\\log_a(x):\\quad x>0
$$
`;function c(){let{locale:c}=t();return e(i,{id:`exponential-logarithmic-functions`,content:{es:a,ca:o,en:s}[c],directiveComponents:{"function-graph":n(()=>r(()=>import(`./FunctionGraph-F7qGvVTE.js`),__vite__mapDeps([0,1,2,3,4,5,6])))}})}export{c as default};