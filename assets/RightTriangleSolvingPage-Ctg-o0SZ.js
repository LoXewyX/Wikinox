const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/RightTriangleDiagram-Y8mRrPKR.js","assets/jsxRuntime.module-BcIaG-9p.js","assets/index-BYtsCiYd.js","assets/index-BUO5hoW9.css"])))=>i.map(i=>d[i]);
import{t as e}from"./jsxRuntime.module-BcIaG-9p.js";import{c as t,d as n,f as r}from"./index-BYtsCiYd.js";import{t as i}from"./TopicPage-BAzQYl-h.js";var a=`# Resolución de triángulos rectángulos
...
`;function c(){let{locale:c}=t();return e(i,{id:`right-triangle-solving`,content:{es:a,ca:o,en:s}[c],directiveComponents:{"right-triangle-diagram":n(()=>r(()=>import(`./RightTriangleDiagram-Y8mRrPKR.js`),__vite__mapDeps([0,1,2,3])))}})}export{c as default};