...
import{t as e}from"./jsxRuntime.module-BcIaG-9p.js";import{c as t,d as n,f as r}from"./index-d08MTCHk.js";import{t as i}from"./TopicPage-BLzDn4N1.js";var a=`# Continuidad de las funciones racionales
...
:::function-graph{expression="(x^2-1)/(x^2-3*x+2)" restriction="-5<=x<=5"}
:::
`;function c(){let{locale:c}=t();return e(i,{id:`continuity-rational-functions`,content:{es:a,ca:o,en:s}[c],directiveComponents:{"function-graph":n(()=>r(()=>import(`./FunctionGraph-ChTwH7hg.js`),__vite__mapDeps([0,1,2,3,4,5,6])))}})}export{c as default};