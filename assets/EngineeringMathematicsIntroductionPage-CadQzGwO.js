...
import{t as e}from"./jsxRuntime.module-BcIaG-9p.js";import{c as t,d as n,f as r}from"./index-CQZABaDC.js";import{t as i}from"./TopicPage-DyShI14R.js";var a=`# Introducción a las matemáticas de ingeniería
...
`;function c(){let{locale:c}=t();return e(i,{id:`engineering-mathematics-introduction`,content:{es:a,ca:o,en:s}[c],directiveComponents:{"function-graph":n(()=>r(()=>import(`./FunctionGraph-Cuk8m7yK.js`),__vite__mapDeps([0,1,2,3,4,5,6])))}})}export{c as default};